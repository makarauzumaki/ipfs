...
declare function ipfsClient(options?: import("./lib/core").ClientOptions): {
    ...
    files: {
        ...
        write: (path: string, input: string | Uint8Array | Blob | AsyncIterable<Uint8Array>, options?: (import("ipfs-core/src/components/files/write").WriteOptions & import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => Promise<void>;
    };
